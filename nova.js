...
/* ===== PIPELINE DASHBOARD — the one page that connects every other page ===== */
const PIPE_T = {
  pipeline: { en:"Creator Pipeline", zh:"创作者流水线", hi:"क्रिएटर पाइपलाइन", es:"Canal de Creación", ar:"خط الإنتاج الإبداعي", fr:"Pipeline Créateur", bn:"ক্রিয়েটর পাইপলাইন", pt:"Pipeline de Criação", ru:"Творческий конвейер", ur:"کریئٹر پائپ لائن", id:"Alur Kreator", de:"Creator-Pipeline", ja:"クリエイターパイプライン", tr:"Yaratıcı Hattı", ko:"크리에이터 파이프라인", fa:"خط تولید خالق", uk:"Конвеєр творця", it:"Pipeline Creatore", pl:"Pion Twórcy", vi:"Quy trình Sáng tạo" },
  pipe_sub: { en:"One project, ten stages — from trend to published, with the next move suggested after every step. Projects and Creator DNA stay in this browser.", zh:"一个项目，十个阶段——从趋势到发布，每一步之后都会建议下一步。项目和创作者 DNA 保存在此浏览器中。", hi:"एक प्रोजेक्ट, दस चरण — ट्रेंड से पब्लिश तक, हर कदम के बाद अगला कदम सुझाया जाता है। प्रोजेक्ट और क्रिएटर DNA इसी ब्राउज़र में रहते हैं।", es:"Un proyecto, diez etapas — de tendencia a publicación, con el siguiente paso sugerido tras cada uno. Los proyectos y el ADN de creador se quedan en este navegador.", ar:"مشروع واحد، عشر مراحل — من الاتجاه إلى النشر، مع اقتراح الخطوة التالية بعد كل خطوة. تبقى المشاريع وملف DNA للصانع في هذا المتصفح.", fr:"Un projet, dix étapes — de la tendance à la publication, chaque pas suggérant le suivant. Projets et ADN de créateur restent dans ce navigateur.", bn:"একটি প্রজেক্ট, দশটি ধাপ — ট্রেন্ড থেকে পাবলিশ পর্যন্ত, প্রতিটি ধাপের পর পরের পরামর্শ। প্রজেক্ট ও ক্রিয়েটর DNA এই ব্রাউজারেই থাকে।", pt:"Um projeto, dez etapas — da tendência à publicação, com o próximo passo sugerido a cada etapa. Projetos e ADN de criador ficam neste navegador.", ru:"Один проект, десять этапов — от тренда до публикации, со следующим шагом после каждого. Проекты и ДНК создателя остаются в этом браузере.", ur:"ایک پروجیکٹ، دس مراحل — ٹرینڈ سے پبلش تک، ہر قدم کے بعد اگلا قدم تجویز۔ پروجیکٹس اور کریئٹر DNA اسی براؤزر میں رہتے ہیں۔", id:"Satu proyek, sepuluh tahap — dari tren hingga publikasi, dengan langkah berikutnya disarankan setelah tiap langkah. Proyek dan DNA kreator tetap di browser ini.", de:"Ein Projekt, zehn Stufen — vom Trend zur Veröffentlichung, mit dem nächsten Schritt nach jedem. Projekte und Creator-DNA bleiben in diesem Browser.", ja:"1プロジェクト、10ステージ — トレンドから公開まで、各ステップの次を提案。プロジェクトとクリエイターDNAはこのブラウザに残ります。", tr:"Tek proje, on aşama — trendden yayına, her adımdan sonra sıradaki önerilir. Projeler ve Yaratıcı DNA bu tarayıcıda kalır.", ko:"한 프로젝트, 열 단계 — 트렌드부터 게시까지, 매 단계 후 다음을 제안합니다. 프로젝트와 크리에이터 DNA는 이 브라우저에 남습니다.", fa:"یک پروژه، ده مرحله — از ترند تا انتشار، با پیشنهاد قدم بعدی پس از هر مرحله. پروژه‌ها و DNA خالق در همین مرورگر می‌مانند.", uk:"Один проєкт, десять етапів — від тренду до публікації, з наступним кроком після кожного. Проєкти та ДНК творця залишаються в цьому браузері.", it:"Un progetto, dieci fasi — dalla tendenza alla pubblicazione, con il passo successivo suggerito dopo ciascuno. Progetti e DNA del creatore restano in questo browser.", pl:"Jeden projekt, dziesięć etapów — od trendu po publikację, z propozycją kolejnego kroku po każdym. Projekty i DNA twórcy zostają w tej przeglądarce.", vi:"Một dự án, mười giai đoạn — từ xu hướng đến xuất bản, mỗi bước gợi ý bước tiếp theo. Dự án và DNA nhà sáng tạo ở lại trình duyệt này." },
  pipe_demo: { en:"Live locally", zh:"本地实时", hi:"लोकल लाइव", es:"En vivo local", ar:"مباشر محليًا", fr:"En direct localement", bn:"লোকালে লাইভ", pt:"Ao vivo local", ru:"Локально", ur:"لوکل لائیو", id:"Live lokal", de:"Lokal live", ja:"ローカルでライブ", tr:"Yerel canlı", ko:"로컬 라이브", fa:"پخش زنده محلی", uk:"Локально наживо", it:"Live locale", pl:"Na żywo lokalnie", vi:"Trực tiếp cục bộ" },
  pipe_next: { en:"Your next move", zh:"你的下一步", hi:"आपका अगला कदम", es:"Tu siguiente paso", ar:"خطوتك التالية", fr:"Ta prochaine étape", bn:"আপনার পরবর্তী পদক্ষেপ", pt:"O teu próximo passo", ru:"Твой следующий шаг", ur:"آپ کا اگلا قدم", id:"Langkahmu berikutnya", de:"Dein nächster Schritt", ja:"次の一手", tr:"Sıradaki hamlen", ko:"다음 행동", fa:"قدم بعدی تو", uk:"Твій наступний крок", it:"Il tuo prossimo passo", pl:"Twój następny krok", vi:"Bước tiếp theo của bạn" },
  pipe_status: { en:"Project status", zh:"项目状态", hi:"प्रोजेक्ट स्थिति", es:"Estado del proyecto", ar:"حالة المشروع", fr:"État du projet", bn:"প্রজেক্টের অবস্থা", pt:"Estado do projeto", ru:"Статус проекта", ur:"پروجیکٹ کی حالت", id:"Status proyek", de:"Projektstatus", ja:"プロジェクト状況", tr:"Proje durumu", ko:"프로젝트 상태", fa:"وضعیت پروژه", uk:"Статус проєкту", it:"Stato del progetto", pl:"Status projektu", vi:"Trạng thái dự án" },
  pipe_stages: { en:"stages done", zh:"阶段已完成", hi:"चरण पूरे", es:"etapas completadas", ar:"مراحل مكتملة", fr:"étapes terminées", bn:"ধাপ সম্পন্ন", pt:"etapas concluídas", ru:"этапов пройдено", ur:"مراحل مکمل", id:"tahap selesai", de:"Stufen erledigt", ja:"完了ステージ", tr:"tamamlanan aşama", ko:"완료 단계", fa:"مرحله انجام‌شده", uk:"етапів виконано", it:"fasi completate", pl:"etapy ukończone", vi:"giai đoạn đã xong" },
  pipe_dna: { en:"Creator DNA", zh:"创作者 DNA", hi:"क्रिएटर DNA", es:"ADN de creador", ar:"DNA الصانع", fr:"ADN de créateur", bn:"ক্রিয়েটর DNA", pt:"ADN de criador", ru:"ДНК создателя", ur:"کریئٹر DNA", id:"DNA kreator", de:"Creator-DNA", ja:"クリエイターDNA", tr:"Yaratıcı DNA", ko:"크리에이터 DNA", fa:"DNA خالق", uk:"ДНК творця", it:"DNA del creatore", pl:"DNA twórcy", vi:"DNA nhà sáng tạo" },
  pipe_open: { en:"Open", zh:"打开", hi:"खोलें", es:"Abrir", ar:"فتح", fr:"Ouvrir", bn:"খুলুন", pt:"Abrir", ru:"Открыть", ur:"کھولیں", id:"Buka", de:"Öffnen", ja:"開く", tr:"Aç", ko:"열기", fa:"باز کن", uk:"Відкрити", it:"Apri", pl:"Otwórz", vi:"Mở" },
  pipe_new: { en:"New project", zh:"新项目", hi:"नया प्रोजेक्ट", es:"Nuevo proyecto", ar:"مشروع جديد", fr:"Nouveau projet", bn:"নতুন প্রজেক্ট", pt:"Novo projeto", ru:"Новый проект", ur:"نیا پروجیکٹ", id:"Proyek baru", de:"Neues Projekt", ja:"新規プロジェクト", tr:"Yeni proje", ko:"새 프로젝트", fa:"پروژه جدید", uk:"Новий проєкт", it:"Nuovo progetto", pl:"Nowy projekt", vi:"Dự án mới" },
  pipe_upload: { en:"Upload", zh:"上传", hi:"अपलोड", es:"Subir", ar:"رفع", fr:"Téléverser", bn:"আপলোড", pt:"Enviar", ru:"Загрузить", ur:"اپ لوڈ", id:"Unggah", de:"Hochladen", ja:"アップロード", tr:"Yükle", ko:"업로드", fa:"آپلود", uk:"Завантажити", it:"Carica", pl:"Prześlij", vi:"Tải lên" },
  pipe_analyze: { en:"AI Analysis", zh:"AI 分析", hi:"AI विश्लेषण", es:"Análisis IA", ar:"تحليل الذكاء الاصطناعي", fr:"Analyse IA", bn:"AI বিশ্লেষণ", pt:"Análise IA", ru:"ИИ-анализ", ur:"AI تجزیہ", id:"Analisis AI", de:"KI-Analyse", ja:"AI分析", tr:"YZ Analizi", ko:"AI 분석", fa:"تحلیل هوش مصنوعی", uk:"ШІ-аналіз", it:"Analisi IA", pl:"Analiza AI", vi:"Phân tích AI" },
  pipe_direct: { en:"AutoDirector", zh:"自动导演", hi:"ऑटोडायरेक्टर", es:"Autodirector", ar:"المخرج الآلي", fr:"AutoDirecteur", bn:"অটোডিরেক্টর", pt:"Autodiretor", ru:"Авторежиссёр", ur:"آٹو ڈائریکٹر", id:"AutoSutradara", de:"AutoDirector", ja:"オートディレクター", tr:"Otomatik Yönetmen", ko:"오토 디렉터", fa:"کارگردان خودکار", uk:"Авторежисер", it:"Autoregista", pl:"Autoreżyser", vi:"Đạo diễn tự động" },
  pipe_seo: { en:"Title + SEO", zh:"标题 + SEO", hi:"टाइटल + SEO", es:"Título + SEO", ar:"العنوان + تحسين محركات البحث", fr:"Titre + SEO", bn:"টাইটেল + SEO", pt:"Título + SEO", ru:"Заголовок + SEO", ur:"ٹائٹل + SEO", id:"Judul + SEO", de:"Titel + SEO", ja:"タイトル + SEO", tr:"Başlık + SEO", ko:"제목 + SEO", fa:"عنوان + سئو", uk:"Заголовок + SEO", it:"Titolo + SEO", pl:"Tytuł + SEO", vi:"Tiêu đề + SEO" },
  pipe_improve: { en:"Improve", zh:"改进", hi:"बेहतर करें", es:"Mejorar", ar:"حسّن", fr:"Améliorer", bn:"উন্নতি", pt:"Melhorar", ru:"Улучшить", ur:"بہتر بنائیں", id:"Tingkatkan", de:"Verbessern", ja:"改善", tr:"Geliştir", ko:"개선", fa:"بهتر کن", uk:"Покращити", it:"Migliora", pl:"Ulepsz", vi:"Cải thiện" },
  pipe_idea: { en:"Idea", zh:"创意", hi:"आइडिया", es:"Idea", ar:"فكرة", fr:"Idée", bn:"আইডিয়া", pt:"Idea", ru:"Идея", ur:"آئیڈیا", id:"Ide", de:"Idee", ja:"アイデア", tr:"Fikir", ko:"아이디어", fa:"ایده", uk:"Ідея", it:"Idea", pl:"Pomysł", vi:"Ý tưởng" },
  pipe_publish: { en:"Publish", zh:"发布", hi:"पब्लिश", es:"Publicar", ar:"نشر", fr:"Publier", bn:"পাবলিশ", pt:"Publicar", ru:"Опубликовать", ur:"پبلش", id:"Terbitkan", de:"Veröffentlichen", ja:"公開", tr:"Yayınla", ko:"게시", fa:"انتشار", uk:"Опублікувати", it:"Pubblica", pl:"Publikuj", vi:"Xuất bản" },
  pipe_trend: { en:"Trend", zh:"趋势", hi:"ट्रेंड", es:"Tendencia", ar:"الاتجاه", fr:"Tendance", bn:"ট্রেন্ড", pt:"Tendência", ru:"Тренд", ur:"ٹرینڈ", id:"Tren", de:"Trend", ja:"トレンド", tr:"Trend", ko:"트렌드", fa:"ترند", uk:"Тренд", it:"Tendenza", pl:"Trend", vi:"Xu hướng" },
  pipe_script: { en:"Script", zh:"脚本", hi:"स्क्रिप्ट", es:"Guion", ar:"النص", fr:"Scénario", bn:"স্ক্রিপ্ট", pt:"Guião", ru:"Сценарий", ur:"اسکرپٹ", id:"Naskah", de:"Skript", ja:"脚本", tr:"Senaryo", ko:"대본", fa:"سناریو", uk:"Сценарій", it:"Copione", pl:"Scenariusz", vi:"Kịch bản" },
  pipe_thumb: { en:"Thumbnail", zh:"缩略图", hi:"थंबनेल", es:"Miniatura", ar:"صورة مصغرة", fr:"Miniature", bn:"থাম্বনেইল", pt:"Thumbnail", ru:"Превью", ur:"تھمب نیل", id:"Thumbnail", de:"Thumbnail", ja:"サムネイル", tr:"Küçük resim", ko:"썸네일", fa:"تصویر بندانگشتی", uk:"Прев’ю", it:"Miniatura", pl:"Miniatura", vi:"Ảnh thu nhỏ" }
};
Object.assign(T, PIPE_T);
...
const NC_ICONS = {
  ...
  pipeline:  'M4 4h16v5H4zM4 10h16v5H4zM4 16h16v4H4zM8 6.5h2M8 12.5h2M8 18.5h2',
...
const NC_NAV = [
  ...
  { name: 'Create', icon: 'editor', items: [
      ['pipeline.html', 'Pipeline', 'pipeline', 'pipeline'], ['editor.html', 'Editor', 'editor', 'editor'], ['publish.html', 'Publish', '', 'publish']] },
