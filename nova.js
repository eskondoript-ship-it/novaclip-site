...
const LANGS = { en: 'English', pt: 'Português', fa: 'فارسی', fr: 'Français', de: 'Deutsch' };
const RTL = ['fa'];
const T = {
  welcome: { en:'👋 Welcome to NovaClip!', pt:'👋 Bem-vindo ao NovaClip!', fa:'👋 به NovaClip خوش آمدید!', fr:'👋 Bienvenue sur NovaClip !', de:'👋 Willkommen bei NovaClip!' },
  home: { en:'Home', pt:'Início', fa:'خانه', fr:'Accueil', de:'Start' },
  studio: { en:'Studio', pt:'Estúdio', fa:'استودیو', fr:'Studio', de:'Studio' },
  trends: { en:'Trend Spotter', pt:'Radar de Tendências', fa:'ردیاب ترند', fr:'Détecteur de Tendances', de:'Trend-Radar' },
  ai: { en:'NovaClip AI', pt:'IA NovaClip', fa:'هوش مصنوعی', fr:'IA NovaClip', de:'NovaClip KI' },
  intro: { en:'Your AI coach for YouTube growth. Analyze your channel, duel rivals, generate thumbnails and plan videos. Earn points and unlock NovaClip Pro rewards! 🏆', pt:'O teu treinador de IA para crescer no YouTube. Analisa o teu canal, desafia rivais, cria thumbnails e planeia vídeos. Ganha pontos! 🏆', fa:'مربی هوش مصنوعی شما برای رشد در یوتیوب. کانالتان را تحلیل کنید، با رقبا مبارزه کنید و ویدیو برنامه‌ریزی کنید. امتیاز بگیرید! 🏆', fr:"Votre coach IA pour grandir sur YouTube. Analysez votre chaîne, défiez des rivaux et planifiez des vidéos. Gagnez des points ! 🏆", de:'Dein KI-Coach für YouTube-Wachstum. Analysiere deinen Kanal, fordere Rivalen heraus und plane Videos. Sammle Punkte! 🏆' }
};
function lang() { return localStorage.getItem('nc_lang') || 'en'; }
function tr(key) { return (T[key] && T[key][lang()]) || (T[key] && T[key].en) || ''; }
function langInstruction() { const n = { en:'English', pt:'Portuguese', fa:'Farsi (Persian)', fr:'French', de:'German' }; return ' Reply ONLY in ' + n[lang()] + '. '; }
