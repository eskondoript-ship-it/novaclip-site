...
const T = {
  ...
  startcreating: { en:"Start Creating", zh:"开始创作", hi:"बनाना शुरू करो", es:"Empieza a crear", ar:"ابدأ الإنشاء", fr:"Commencer à créer", bn:"তৈরি শুরু করো", pt:"Começar a criar", ru:"Начать творить", ur:"بنانا شروع کریں", id:"Mulai berkarya", de:"Loslegen", ja:"作りはじめる", tr:"Üretmeye başla", ko:"제작 시작", fa:"شروع ساخت", uk:"Почати творити", it:"Inizia a creare", pl:"Zacznij tworzyć", vi:"Bắt đầu sáng tạo" },
  seehow: { en:"See How It Works", zh:"看看怎么用", hi:"कैसे काम करता है", es:"Cómo funciona", ar:"كيف يعمل", fr:"Comment ça marche", bn:"কীভাবে কাজ করে", pt:"Como funciona", ru:"Как это работает", ur:"یہ کیسے کام کرتا ہے", id:"Cara kerjanya", de:"So funktioniert es", ja:"仕組みを見る", tr:"Nasıl çalışır", ko:"작동 방식 보기", fa:"چطور کار می‌کند", uk:"Як це працює", it:"Come funziona", pl:"Jak to działa", vi:"Cách hoạt động" },
  hero_lede: { en:"NovaClip is the AI co-pilot that takes the thing in your head and walks it all the way to published — script, edit, captions, thumbnail — then turns growing your channel into something you actually want to play.", zh:"NovaClip 是你的 AI 副驾驶：把脑子里的想法一路带到发布——脚本、剪辑、字幕、封面——再把频道成长变成你真心想玩的游戏。", es:"NovaClip es el copiloto de IA que coge lo que tienes en la cabeza y lo lleva hasta publicado — guion, edición, subtítulos, miniatura — y convierte hacer crecer tu canal en algo que de verdad quieres jugar.", pt:"O NovaClip é o co-piloto de IA que pega no que tens na cabeça e leva-o até publicado — guião, edição, legendas, miniatura — e transforma o crescimento do canal em algo que queres mesmo jogar.", fr:"NovaClip est le copilote IA qui prend ce que tu as en tête et le mène jusqu’à la publication — script, montage, sous-titres, miniature — puis transforme la croissance de ta chaîne en quelque chose que tu as envie de jouer.", de:"NovaClip ist der KI-Co-Pilot, der die Idee in deinem Kopf bis zur Veröffentlichung bringt — Skript, Schnitt, Untertitel, Thumbnail — und Kanalwachstum in etwas verwandelt, das du wirklich spielen willst.", ar:"نوفاكليب هو المساعد الذكي الذي يأخذ ما في رأسك ويوصله إلى النشر — النص والمونتاج والترجمة والصورة المصغّرة — ثم يحوّل نمو قناتك إلى لعبة تريد لعبها.", fa:"نواکلیپ همان کمک‌خلبان هوش مصنوعی است که ایده‌ی توی سرت را تا انتشار می‌برد — متن، تدوین، زیرنویس، تامبنیل — و رشد کانال را به بازی‌ای تبدیل می‌کند که واقعاً دوست داری بازی کنی." },
  pipe_idea: { en:"Idea", es:"Idea", pt:"Ideia", fr:"Idée", de:"Idee", ar:"فكرة", fa:"ایده", zh:"想法", ja:"アイデア", ko:"아이디어", ru:"Идея", it:"Idea", pl:"Pomysł", tr:"Fikir", uk:"Ідея", id:"Ide", vi:"Ý tưởng", hi:"आइडिया", bn:"আইডিয়া", ur:"آئیڈیا" },
  pipe_ai: { en:"AI", es:"IA", pt:"IA", fr:"IA", de:"KI", ar:"ذكاء", fa:"هوش مصنوعی", zh:"AI", ja:"AI", ko:"AI", ru:"ИИ", it:"IA", pl:"AI", tr:"YZ", uk:"ШІ", id:"AI", vi:"AI", hi:"एआई", bn:"এআই", ur:"اے آئی" },
  pipe_video: { en:"Video", es:"Vídeo", pt:"Vídeo", fr:"Vidéo", de:"Video", ar:"فيديو", fa:"ویدیو", zh:"视频", ja:"動画", ko:"영상", ru:"Видео", it:"Video", pl:"Wideo", tr:"Video", uk:"Відео", id:"Video", vi:"Video", hi:"वीडियो", bn:"ভিডিও", ur:"ویڈیو" },
  pipe_publish: { en:"Publish", es:"Publicar", pt:"Publicar", fr:"Publier", de:"Veröffentlichen", ar:"نشر", fa:"انتشار", zh:"发布", ja:"公開", ko:"게시", ru:"Публикация", it:"Pubblica", pl:"Publikuj", tr:"Yayınla", uk:"Публікація", id:"Terbitkan", vi:"Đăng", hi:"प्रकाशित", bn:"প্রকাশ", ur:"شائع" },
  pipe_growth: { en:"Growth", es:"Crecimiento", pt:"Crescimento", fr:"Croissance", de:"Wachstum", ar:"نمو", fa:"رشد", zh:"增长", ja:"成長", ko:"성장", ru:"Рост", it:"Crescita", pl:"Wzrost", tr:"Büyüme", uk:"Зростання", id:"Pertumbuhan", vi:"Tăng trưởng", hi:"ग्रोथ", bn:"গ্রোথ", ur:"ترقی" },
  pipe_growth_d: { en:"views this week", es:"visitas esta semana", pt:"visualizações esta semana", fr:"vues cette semaine", de:"Aufrufe diese Woche", ar:"مشاهدات هذا الأسبوع", fa:"بازدید این هفته", zh:"本周播放量", ja:"今週の再生", ko:"이번 주 조회수", ru:"просмотров за неделю", it:"visualizzazioni", pl:"wyświetleń w tym tygodniu", tr:"bu hafta izlenme", uk:"переглядів за тиждень", id:"tayangan minggu ini", vi:"lượt xem tuần này", hi:"इस हफ़्ते व्यूज़", bn:"এই সপ্তাহে ভিউ", ur:"اس ہفتے ویوز" },
  ...
  hero_line1: { en:"Turn your idea", zh:"把你的想法", hi:"अपने आइडिया को", es:"Convierte tu idea", ar:"حوّل فكرتك", fr:"Transforme ton idée", bn:"তোমার আইডিয়াকে", pt:"Transforma a tua ideia", ru:"Преврати свою идею", ur:"اپنے آئیڈیا کو", id:"Ubah idemu", de:"Mach aus deiner Idee", ja:"あなたのアイデアを", tr:"Fikrini", ko:"당신의 아이디어를", fa:"ایده‌ات را", uk:"Перетвори свою ідею", it:"Trasforma la tua idea", pl:"Zamień swój pomysł", vi:"Biến ý tưởng của bạn" },
  hero_line2: { en:"into your <b class=\"m\">next video.</b>", zh:"变成<b class=\"m\">下一个视频</b>。", hi:"बनाओ <b class=\"m\">अगला वीडियो।</b>", es:"en tu <b class=\"m\">próximo vídeo.</b>", ar:"إلى <b class=\"m\">فيديوك القادم.</b>", fr:"en ta <b class=\"m\">prochaine vidéo.</b>", bn:"করো <b class=\"m\">পরের ভিডিও।</b>", pt:"no teu <b class=\"m\">próximo vídeo.</b>", ru:"в <b class=\"m\">новое видео.</b>", ur:"بناؤ <b class=\"m\">اگلی ویڈیو۔</b>", id:"jadi <b class=\"m\">video berikutnya.</b>", de:"dein <b class=\"m\">nächstes Video.</b>", ja:"<b class=\"m\">次の動画</b>に。", tr:"<b class=\"m\">bir sonraki videona</b> dönüştür.", ko:"<b class=\"m\">다음 영상</b>으로.", fa:"به <b class=\"m\">ویدیوی بعدی‌ات.</b>", uk:"на <b class=\"m\">нове відео.</b>", it:"nel tuo <b class=\"m\">prossimo video.</b>", pl:"w <b class=\"m\">kolejne wideo.</b>", vi:"thành <b class=\"m\">video tiếp theo.</b>" },
  ...
  missions: { en:"Missions", zh:"任务", hi:"मिशन", es:"Misiones", ar:"المهام", fr:"Missions", bn:"মিশন", pt:"Missões", ru:"Задания", ur:"مشن", id:"Misi", de:"Missionen", ja:"ミッション", tr:"Görevler", ko:"미션", fa:"مأموریت‌ها", uk:"Завдання", it:"Missioni", pl:"Misje", vi:"Nhiệm vụ" },
  claim: { en:"Claim", zh:"领取", hi:"लो", es:"Reclamar", ar:"استلم", fr:"Réclamer", bn:"নাও", pt:"Resgatar", ru:"Забрать", ur:"حاصل کریں", id:"Ambil", de:"Abholen", ja:"受け取る", tr:"Al", ko:"받기", fa:"دریافت", uk:"Забрати", it:"Riscuoti", pl:"Odbierz", vi:"Nhận" },
  claimed: { en:"Claimed", zh:"已领取", hi:"लिया", es:"Reclamado", ar:"تم", fr:"Réclamé", bn:"নেওয়া", pt:"Resgatado", ru:"Получено", ur:"مل گیا", id:"Diambil", de:"Abgeholt", ja:"受取済", tr:"Alındı", ko:"받음", fa:"دریافت شد", uk:"Отримано", it:"Riscosso", pl:"Odebrano", vi:"Đã nhận" },
  xp: { en:"XP", zh:"经验", hi:"XP", es:"XP", ar:"نقاط", fr:"XP", bn:"XP", pt:"XP", ru:"опыт", ur:"XP", id:"XP", de:"XP", ja:"XP", tr:"XP", ko:"XP", fa:"امتیاز", uk:"досвід", it:"XP", pl:"XP", vi:"XP" },
  level: { en:"Level", zh:"等级", hi:"लेवल", es:"Nivel", ar:"المستوى", fr:"Niveau", bn:"লেভেল", pt:"Nível", ru:"Уровень", ur:"لیول", id:"Level", de:"Level", ja:"レベル", tr:"Seviye", ko:"레벨", fa:"سطح", uk:"Рівень", it:"Livello", pl:"Poziom", vi:"Cấp" },
  streak: { en:"Day streak", zh:"连续天数", hi:"स्ट्रीक", es:"Racha", ar:"أيام متتالية", fr:"Série", bn:"স্ট্রিক", pt:"Sequência", ru:"Серия дней", ur:"سلسلہ", id:"Runtutan", de:"Serie", ja:"連続日数", tr:"Seri", ko:"연속", fa:"روزهای پیاپی", uk:"Серія", it:"Serie", pl:"Passa", vi:"Chuỗi ngày" },
  best: { en:"best", zh:"最佳", hi:"सर्वश्रेष्ठ", es:"mejor", ar:"الأفضل", fr:"record", bn:"সেরা", pt:"melhor", ru:"рекорд", ur:"بہترین", id:"terbaik", de:"Bestwert", ja:"最高", tr:"en iyi", ko:"최고", fa:"بهترین", uk:"рекорд", it:"record", pl:"rekord", vi:"tốt nhất" },
  levelup: { en:"Level {n} reached", zh:"达到等级 {n}", hi:"लेवल {n}", es:"¡Nivel {n}!", ar:"وصلت للمستوى {n}", fr:"Niveau {n} atteint", bn:"লেভেল {n}", pt:"Nível {n} alcançado", ru:"Уровень {n}", ur:"لیول {n}", id:"Level {n} tercapai", de:"Level {n} erreicht", ja:"レベル {n} 到達", tr:"Seviye {n}", ko:"레벨 {n} 달성", fa:"سطح {n}", uk:"Рівень {n}", it:"Livello {n}", pl:"Poziom {n}", vi:"Đạt cấp {n}" },
  prog_open: { en:"Your level, XP and streak", zh:"等级、经验与连续天数", hi:"लेवल, XP और स्ट्रीक", es:"Tu nivel, XP y racha", ar:"مستواك ونقاطك", fr:"Niveau, XP et série", bn:"লেভেল, XP ও স্ট্রিক", pt:"Nível, XP e sequência", ru:"Уровень, опыт и серия", ur:"لیول، XP اور سلسلہ", id:"Level, XP dan runtutan", de:"Level, XP und Serie", ja:"レベル・XP・連続", tr:"Seviye, XP ve seri", ko:"레벨, XP, 연속", fa:"سطح، امتیاز و روزها", uk:"Рівень, досвід і серія", it:"Livello, XP e serie", pl:"Poziom, XP i passa", vi:"Cấp, XP và chuỗi" },
...
/* ============================================================================
   PROGRESSION — level, XP and streak
   ============================================================================
   Built on the two things the site already records, so none of it is
   decoration:

     nc_points   NovaCoins, awarded by addPts() from real actions
     nc_skills   a ledger of hands-on reps (exports, scans, AI questions)

   Level comes from points on a curve that widens as it goes: level 2 costs
   60, level 20 costs a few thousand. A flat cost makes the first level feel
   like nothing and the twentieth unreachable; this keeps each one about a
   session's work.

   The streak is real. It records the last calendar day the site was opened
   and the run length, and a gap of more than one day resets it. Nothing here
   invents a number it was not given.
   --------------------------------------------------------------------------- */

/* Total points needed to REACH a level. Quadratic-ish: 40n² + 20n. */
function ncLevelFloor(level) {
  if (level <= 1) return 0;
  const n = level - 1;
  return 40 * n * n + 20 * n;
}

function ncLevelOf(points) {
  let lvl = 1;
  while (lvl < 99 && points >= ncLevelFloor(lvl + 1)) lvl++;
  return lvl;
}

/* Everything a bar needs, in one object, so callers never recompute it. */
function ncProgress() {
  const pts = (typeof getPts === 'function') ? getPts() : 0;
  const level = ncLevelOf(pts);
  const from = ncLevelFloor(level), to = ncLevelFloor(level + 1);
  const into = Math.max(0, pts - from), span = Math.max(1, to - from);
  return {
    points: pts, level: level, into: into, span: span,
    need: Math.max(0, to - pts),
    pct: Math.max(0, Math.min(100, into / span * 100))
  };
}
window.ncProgress = ncProgress;
window.ncLevelOf = ncLevelOf;

/* ---- streak ----
   Days are compared as local YYYY-MM-DD rather than by subtracting
   timestamps, because "yesterday" is a calendar idea: 23:50 to 00:10 is a new
   day and twenty minutes, and a timestamp difference calls that the same day.
*/
function ncDayKey(d) {
  d = d || new Date();
...
function ncStreak() {
  let s;
  try { s = JSON.parse(localStorage.getItem('nc_streak') || 'null'); } catch (e) { s = null; }
  if (!s || typeof s !== 'object') s = { last: '', run: 0, best: 0 };
  const today = ncDayKey();
  if (s.last === today) return s;

  const y = new Date(); y.setDate(y.getDate() - 1);
  s.run = (s.last === ncDayKey(y)) ? (s.run || 0) + 1 : 1;
  s.last = today;
  s.best = Math.max(s.best || 0, s.run);
  try { localStorage.setItem('nc_streak', JSON.stringify(s)); } catch (e) {}
  return s;
}
window.ncStreak = ncStreak;

/* ---- the rail card ----
   Level, the bar to the next one, and the streak — on every page, because the
   rail is on every page. */
function ncBuildProgressCard() {
  if (NC_EMBED) return;
  const bar = document.querySelector('.sidebar');
  if (!bar || document.getElementById('ncProg')) return;

  const box = document.createElement('a');
  box.id = 'ncProg';
  box.href = 'progress.html';
  /* Class, not inline styles: the mobile rail has to shrink this to a badge,
     and an inline style beats every media query that tries. */
  box.className = 'nc-glass nc-progcard';
  box.setAttribute('aria-label', tr('prog_open'));

  box.innerHTML =
    '<div style="display:flex;align-items:center;gap:9px">' +
      '<span class="nc-lvl" id="ncLvl">1</span>' +
      '<span style="flex:1;min-width:0">' +
        '<span style="display:block;font-size:.72rem;letter-spacing:.06em;text-transform:uppercase;' +
        'font-weight:750;color:var(--nc-dim)">' + tr('level') + '</span>' +
        '<span style="display:block;font-size:.78rem;font-variant-numeric:tabular-nums" id="ncXpTxt">0 / 0</span>' +
      '</span>' +
      '<span id="ncStreak" class="nc-chip" style="padding:3px 8px" title="' + tr('streak') + '">0</span>' +
    '</div>' +
    '<div class="nc-xpbar thin" style="margin-top:8px" role="progressbar" aria-valuemin="0" ' +
      'aria-valuemax="100" aria-valuenow="0" id="ncXpBar"><span style="width:0%"></span></div>';

  /* Near the top, under the brand. It was below the nav to begin with, which
     put it under the fold on a laptop — a progress bar nobody scrolls to is
     not a progress bar. #ncnav is the nav block, so this lands just above it. */
  const nav = bar.querySelector('#ncnav');
  if (nav && nav.parentNode === bar) bar.insertBefore(box, nav);
  else {
    const tail = bar.querySelector('.themewrap');
    if (tail) bar.insertBefore(box, tail); else bar.appendChild(box);
  }
  ncPaintProgress(true);
}

let ncLastLevel = null;

function ncPaintProgress(first) {
  const box = document.getElementById('ncProg');
  if (!box) return;
  const p = ncProgress(), s = ncStreak();

  document.getElementById('ncLvl').textContent = p.level;
  document.getElementById('ncXpTxt').textContent =
    p.into.toLocaleString() + ' / ' + p.span.toLocaleString();
  const bar = document.getElementById('ncXpBar');
  bar.setAttribute('aria-valuenow', Math.round(p.pct));
  /* On the first paint the width is set from zero on the next frame, so the
     bar fills in rather than appearing already full. */
  const fill = bar.firstElementChild;
  if (first) requestAnimationFrame(() => { fill.style.width = p.pct + '%'; });
  else fill.style.width = p.pct + '%';

  const st = document.getElementById('ncStreak');
  st.textContent = (s.run > 0 ? '🔥 ' : '') + s.run;
  st.className = 'nc-chip' + (s.run >= 3 ? ' warn' : '');
  st.title = tr('streak') + ': ' + s.run + (s.best > s.run ? ' (' + tr('best') + ' ' + s.best + ')' : '');

  if (ncLastLevel !== null && p.level > ncLastLevel) ncLevelUp(p.level);
  ncLastLevel = p.level;
}
window.ncPaintProgress = ncPaintProgress;

/* ---- level up ----
   A short, quiet celebration: the badge pulses, a ring expands out of it, and
   a toast names the level. No confetti cannon — the brief said sophisticated
   rather than childish, and this fires while someone is mid-task. */
function ncLevelUp(level) {
  let reduced = false;
  try { reduced = matchMedia('(prefers-reduced-motion: reduce)').matches; } catch (e) {}
  if (typeof toast === 'function') toast(tr('levelup').replace('{n}', level));
  if (reduced) return;

  const badge = document.getElementById('ncLvl');
  if (!badge) return;
  const r = badge.getBoundingClientRect();
  const ring = document.createElement('span');
  ring.style.cssText = 'position:fixed;left:' + (r.left + r.width / 2) + 'px;top:' +
    (r.top + r.height / 2) + 'px;width:14px;height:14px;margin:-7px 0 0 -7px;border-radius:50%;' +
    'border:2px solid var(--nc-lvl);pointer-events:none;z-index:99999;animation:nc-ring .9s ease-out forwards';
  document.body.appendChild(ring);
  setTimeout(() => ring.remove(), 950);
  badge.style.animation = 'nc-pop .5s ease';
  setTimeout(() => { badge.style.animation = ''; }, 520);
}

/* Repaint whenever points move. addPts is the single place they change, so it
   is wrapped once here rather than every caller remembering to refresh. */
(function () {
  if (typeof addPts !== 'function' || addPts.__ncWrapped) return;
  const inner = addPts;
  window.addPts = addPts = function (n) {
    const before = (typeof getPts === 'function') ? getPts() : 0;
    const r = inner.apply(this, arguments);
    try {
      ncPaintProgress();
      const gained = ((typeof getPts === 'function') ? getPts() : 0) - before;
      if (gained > 0) ncFloatXp(gained);
    } catch (e) {}
    return r;
  };
  addPts.__ncWrapped = true;
})();

/* The amount floats up off the level badge, which is the only place that tells
   you where the number went. */
function ncFloatXp(n) {
  let reduced = false;
  try { reduced = matchMedia('(prefers-reduced-motion: reduce)').matches; } catch (e) {}
  const badge = document.getElementById('ncLvl');
  ...
  el.textContent = '+' + n;
  el.style.cssText = 'position:fixed;left:' + (r.right + 6) + 'px;top:' + r.top + 'px;' +
    'font:800 .82rem/1 inherit;color:var(--nc-lvl);pointer-events:none;z-index:99999;' +
    'animation:nc-rise-out 1.1s ease-out forwards';
...
/* ============================================================================
   ...
   ============================================================================
   Both are read from state the site already keeps — nc_points and the nc_skills
   ledger — so a bar that says 2/3 means two exports actually happened. A
   mission list that fills itself in would be a screensaver.

   Missions come in two shapes:
     skill   count a logged rep: exports, trend scans, AI questions
     points  a coin threshold
     streak  consecutive days the site was opened
   --------------------------------------------------------------------------- */
const NC_MISSIONS = [
  { id:'m_first_export', icon:'🎬', kind:'skill', key:'edit_export', need:1,  xp:40,
    diff:'Starter', name:'Export your first video', why:'Open the Editor and render anything at all.' },
  { id:'m_three_exports',icon:'🔥', kind:'skill', key:'edit_export', need:3,  xp:90,
    diff:'Easy',    name:'Export 3 videos',        why:'Three finished cuts, however short.' },
  { id:'m_ten_exports',  icon:'🎥', kind:'skill', key:'edit_export', need:10, xp:260,
    diff:'Hard',    name:'Export 10 videos',       why:'The point where editing stops being fiddly.' },
  { id:'m_trends',       icon:'🎯', kind:'skill', key:'trend_scan',  need:5,  xp:110,
    diff:'Easy',    name:'Run 5 Trend Spotter scans', why:'Find out what your size of channel can reach.' },
  { id:'m_ask',          icon:'✦',  kind:'skill', key:'ai_ask',      need:10, xp:120,
    diff:'Easy',    name:'Ask the AI 10 questions', why:'Coach, director, clip finder — any of them.' },
  { id:'m_ideas',        icon:'💡', kind:'skill', key:'idea_save',   need:5,  xp:100,
    diff:'Easy',    name:'Save 5 ideas',           why:'A shortlist beats a blank page on a bad day.' },
  { id:'m_analytics',    icon:'📊', kind:'skill', key:'analytics',   need:5,  xp:100,
    diff:'Medium',  name:'Review your analytics 5 times', why:'Watching the numbers is half of growing.' },
  { id:'m_connect',      icon:'🔗', kind:'skill', key:'yt_connect',  need:1,  xp:60,
    diff:'Starter', name:'Connect your channel',   why:'Unlocks real analytics instead of examples.' },
  { id:'m_streak3',      icon:'⚡', kind:'streak', need:3,  xp:80,
    diff:'Easy',    name:'3 days in a row',        why:'Turn up three days running.' },
  { id:'m_streak7',      icon:'⚡', kind:'streak', need:7,  xp:220,
    diff:'Hard',    name:'7 day streak',           why:'A week straight. This is the one that sticks.' },
  { id:'m_coins500',     icon:'🪙', kind:'points', need:500, xp:150,
    diff:'Medium',  name:'Reach 500 NovaCoins',    why:'Earned across everything you do here.' }
];

function ncMissionState(m) {
  let have = 0;
  if (m.kind === 'skill')  have = (typeof skillCount === 'function') ? skillCount(m.key) : 0;
  else if (m.kind === 'points') have = (typeof getPts === 'function') ? getPts() : 0;
  else if (m.kind === 'streak') have = (ncStreak() || {}).run || 0;
  return { have: Math.min(have, m.need), need: m.need, done: have >= m.need,
           pct: Math.max(0, Math.min(100, have / m.need * 100)) };
}

/* Claiming pays the XP once. The claim list is what stops a completed mission
   from paying every time the page is opened. */
function ncClaimed() {
  try { return JSON.parse(localStorage.getItem('nc_claimed') || '[]') || []; } catch (e) { return []; }
}
function ncClaim(id, xp) {
  const c = ncClaimed();
  if (c.indexOf(id) > -1) return false;
  c.push(id);
  try { localStorage.setItem('nc_claimed', JSON.stringify(c)); } catch (e) {}
  if (typeof addPts === 'function') addPts(xp);
  return true;
}

function ncRenderMissions(host) {
  host = (typeof host === 'string') ? document.getElementById(host) : host;
  if (!host) return;
  const claimed = ncClaimed();
  /* Unfinished first, and inside that the closest to done — so the top of the
     list is always the thing worth doing next. */
  const rows = NC_MISSIONS.map(m => ({ m: m, s: ncMissionState(m) }))
    .sort((a, b) => (a.s.done - b.s.done) || (b.s.pct - a.s.pct));

  host.innerHTML = rows.map(({ m, s }) => {
    const got = claimed.indexOf(m.id) > -1;
    return '<div class="nc-mission' + (s.done ? ' done' : '') + '">' +
      '<span class="ic">' + m.icon + '</span>' +
      '<span style="min-width:0">' +
        '<span class="ttl">' + m.name + '</span>' +
        '<span class="sub">' + m.why + '</span>' +
        '<span class="bar"><span class="nc-xpbar thin" role="progressbar" aria-valuemin="0" aria-valuemax="' +
          m.need + '" aria-valuenow="' + s.have + '"><span style="width:' + s.pct + '%"></span></span></span>' +
        '<span class="sub" style="margin-top:5px">' + s.have + ' / ' + m.need +
          ' &nbsp;·&nbsp; <span class="nc-chip" style="padding:1px 8px">' + m.diff + '</span></span>' +
      '</span>' +
      '<span class="rw">' + (
        s.done
          ? (got ? '<span class="nc-chip ok">' + tr('claimed') + '</span>'
                 : '<button class="nc-btn primary sm" data-claim="' + m.id + '" data-xp="' + m.xp + '">' +
                   tr('claim') + ' +' + m.xp + '</button>')
          : '<b>+' + m.xp + '</b>' + tr('xp')
      ) + '</span>' +
    '</div>';
  }).join('');
  ...
  host.querySelectorAll('[data-claim]').forEach(b => {
    b.onclick = () => {
      if (ncClaim(b.dataset.claim, +b.dataset.xp)) {
        if (typeof toast === 'function') toast('+' + b.dataset.xp + ' ' + tr('xp'));
        ncRenderMissions(host);
      }
    };
  });
}
window.ncRenderMissions = ncRenderMissions;

/* ---- achievements ----
   Coin milestones plus the ones that mark a real first: a first export, a
   first connected channel, a week's streak. Locked ones stay visible, greyed,
   because the next badge is the reason to look at the list at all. */
const NC_BADGES = [
  { icon:'🎬', name:'First video',   test:() => skillCount('edit_export') >= 1,  req:'Export 1 video' },
  { icon:'🔗', name:'Connected',     test:() => skillCount('yt_connect') >= 1,   req:'Link your channel' },
  { icon:'🎯', name:'Scout',         test:() => skillCount('trend_scan') >= 5,   req:'5 trend scans' },
  { icon:'✦',  name:'Curious',       test:() => skillCount('ai_ask') >= 10,      req:'10 AI questions' },
  { icon:'🎥', name:'Ten cuts',      test:() => skillCount('edit_export') >= 10, req:'Export 10 videos' },
  { icon:'📊', name:'Analyst',       test:() => skillCount('analytics') >= 5,    req:'5 analytics reviews' },
  { icon:'⚡', name:'7 day streak',  test:() => (ncStreak().best || 0) >= 7,     req:'7 days running' },
  { icon:'🪙', name:'100 coins',     test:() => getPts() >= 100,   req:'100 NovaCoins' },
  { icon:'💰', name:'500 coins',     test:() => getPts() >= 500,   req:'500 NovaCoins' },
  { icon:'👑', name:'1,500 coins',   test:() => getPts() >= 1500,  req:'1,500 NovaCoins' },
  { icon:'🏆', name:'Level 10',      test:() => ncProgress().level >= 10, req:'Reach level 10' },
  { icon:'🌎', name:'Global',        test:() => { try { return (localStorage.getItem('nc_lang')||'en') !== 'en'; } catch(e){ return false; } },
    req:'Use another language' }
];

function ncRenderBadges(host) {
  host = (typeof host === 'string') ? document.getElementById(host) : host;
  if (!host) return;
  host.innerHTML = NC_BADGES.map(b => {
    let got = false;
    try { got = !!b.test(); } catch (e) {}
    return '<div class="nc-badge ' + (got ? 'got' : 'locked') + '" tabindex="0" ' +
      'title="' + b.req + '"><div class="medal">' + b.icon + '</div>' +
      '<div class="nm">' + b.name + '</div><div class="req">' + b.req + '</div></div>';
  }).join('');
}
window.ncRenderBadges = ncRenderBadges;

/* ============================================================================
   THE DESIGN SYSTEM
   ============================================================================
   Every page loads nova.js and nova.js injects CSS, so this is the one place a
   change reaches all twenty-four of them. Pages keep their own layout; what
   they get from here is the vocabulary — surfaces, borders, buttons, cards,
   stats, bars, badges — so a card on Pricing and a card on Progress are the
   same object rather than two people's idea of one.

   The palette in the theme block above is the base (background, text, accents,
   both themes). This adds the parts an interface needs on top of a palette:
   layered surfaces, semantic colour, and the progression tokens.
   --------------------------------------------------------------------------- */
const ncDS = document.createElement('style');
ncDS.id = 'nc-ds-css';
ncDS.textContent =

":root{" +
  /* Surfaces, in the order they stack. A panel on the page, a card on the
     panel, a popover on the card — each one a step further forward. */
  "--nc-s0:var(--nc-bg); --nc-s1:rgba(255,255,255,.035); --nc-s2:rgba(255,255,255,.06);" +
  "--nc-s3:rgba(255,255,255,.09);" +
  "--nc-bd:rgba(255,255,255,.09); --nc-bd2:rgba(255,255,255,.14);" +
  /* Semantic. Green/amber/red read the same way in every product, so they are
     not up for reinterpretation per page. */
  "--nc-ok:#3DD68C; --nc-warn:#FFB443; --nc-err:#FF5C7A; --nc-info:var(--nc-cyan);" +
  /* Progression. XP is the cyan-violet the brand already uses; level is gold,
     because a level is a rank and rank has always been gold. */
  "--nc-xp:linear-gradient(90deg,#7C5CFF,#00F0FF); --nc-xp-track:rgba(255,255,255,.10);" +
  "--nc-lvl:#FFC93C; --nc-lvl-2:#FF9A3C;" +
  "--nc-r-sm:10px; --nc-r-md:14px; --nc-r-lg:20px; --nc-r-xl:26px;" +
  "--nc-e1:0 1px 2px rgba(0,0,0,.28); --nc-e2:0 8px 24px -14px rgba(0,0,0,.7);" +
  "--nc-e3:0 22px 60px -30px rgba(0,0,0,.85);" +
"}" +
"html[data-theme=\"light\"]{" +
  "--nc-s1:rgba(16,24,44,.028); --nc-s2:rgba(16,24,44,.052); --nc-s3:rgba(16,24,44,.08);" +
  "--nc-bd:rgba(16,24,44,.11); --nc-bd2:rgba(16,24,44,.18);" +
  "--nc-ok:#12855A; --nc-warn:#9A5B00; --nc-err:#C42A46;" +
  "--nc-xp-track:rgba(16,24,44,.10); --nc-lvl:#B07B00; --nc-lvl-2:#C25E00;" +
  "--nc-e1:0 1px 2px rgba(16,24,44,.05); --nc-e2:0 8px 24px -16px rgba(16,24,44,.28);" +
  "--nc-e3:0 22px 60px -34px rgba(16,24,44,.34);" +
"}" +

/* ---- surfaces ------------------------------------------------------------
   The glass is deliberately restrained: a translucent fill, one hairline
   border, and a single highlight along the top edge where light would land.
   Backdrop blur is only applied where something actually sits behind it,
   because it is the most expensive thing on this list. */
".nc-glass{position:relative;background:var(--nc-s1);border:1px solid var(--nc-bd);" +
  "border-radius:var(--nc-r-lg);box-shadow:var(--nc-e2);overflow:hidden}" +
".nc-glass::before{content:'';position:absolute;left:0;right:0;top:0;height:1px;" +
  "background:linear-gradient(90deg,transparent,var(--nc-bd2) 22%,var(--nc-bd2) 78%,transparent);" +
  "pointer-events:none}" +
".nc-glass.blur{backdrop-filter:blur(14px)}" +
".nc-raised{background:var(--nc-s2);border:1px solid var(--nc-bd);border-radius:var(--nc-r-md)}" +

/* A gradient border without a wrapper element: the padding box is painted with
   the surface, the border box with the gradient, and mask-composite cuts the
   middle out. One element, one paint. */
".nc-edge{position:relative;border:1px solid transparent;border-radius:var(--nc-r-lg);" +
  "background:linear-gradient(var(--nc-bg2),var(--nc-bg2)) padding-box," +
  "linear-gradient(120deg,var(--nc-violet),var(--nc-cyan) 48%,var(--nc-pink)) border-box}" +

/* Grain. A tiny SVG turbulence tile at very low opacity, which stops large
   flat panels and gradients from banding on cheap screens. */
".nc-grain::after{content:'';position:absolute;inset:0;pointer-events:none;opacity:.035;" +
  ...
  "<rect width='120' height='120' filter='url(%23n)'/></svg>\");mix-blend-mode:overlay}" +

/* ---- buttons ----
   One shape, four weights. The primary carries the brand gradient; the rest
   get progressively quieter so a screen can have several actions without
   three of them shouting. */
".nc-btn{display:inline-flex;align-items:center;justify-content:center;gap:8px;" +
  "padding:11px 20px;border-radius:var(--nc-r-sm);border:1px solid var(--nc-bd2);" +
  "background:var(--nc-s2);color:var(--nc-text);font:inherit;font-size:.9rem;font-weight:650;" +
...
".nc-btn:hover{background:var(--nc-s3);border-color:var(--nc-bd2)}" +
".nc-btn:active{transform:translateY(1px)}" +
".nc-btn:disabled,.nc-btn[aria-disabled=\"true\"]{opacity:.45;cursor:not-allowed;transform:none}" +
".nc-btn svg{width:17px;height:17px;stroke:currentColor;fill:none;stroke-width:2;" +
  "stroke-linecap:round;stroke-linejoin:round;flex:0 0 auto}" +

".nc-btn.primary{border:0;color:#05070E;background:linear-gradient(110deg,var(--nc-violet),var(--nc-cyan) 52%,var(--nc-pink));" +
  "box-shadow:0 10px 26px -12px rgba(124,92,255,.75)}" +
"html[data-theme=\"light\"] .nc-btn.primary{color:#fff}" +
"@media (hover:hover){.nc-btn.primary:hover{transform:translateY(-1px);" +
  "box-shadow:0 16px 34px -14px rgba(124,92,255,.85)}}" +
".nc-btn.ghost{background:none;border-color:var(--nc-bd)}" +
".nc-btn.ghost:hover{background:var(--nc-s1)}" +
".nc-btn.quiet{background:none;border-color:transparent;color:var(--nc-dim);padding:8px 12px}" +
".nc-btn.quiet:hover{color:var(--nc-text);background:var(--nc-s1)}" +
".nc-btn.sm{padding:8px 14px;font-size:.82rem}" +
".nc-btn.lg{padding:14px 26px;font-size:1rem;border-radius:var(--nc-r-md)}" +
".nc-btn.block{width:100%}" +

/* A slow sheen that crosses the primary button about once every seven seconds.
   Long enough apart to read as light rather than as a loading bar. */
"@keyframes nc-sheen{0%{transform:translateX(-120%)}55%,100%{transform:translateX(220%)}}" +
"@keyframes nc-ring{to{width:120px;height:120px;margin:-60px 0 0 -60px;opacity:0}}" +
"@keyframes nc-rise-out{to{transform:translateY(-26px);opacity:0}}" +
".nc-btn.primary{position:relative;overflow:hidden}" +
".nc-btn.primary::after{content:'';position:absolute;top:0;bottom:0;width:38%;" +
  "background:linear-gradient(100deg,transparent,rgba(255,255,255,.34),transparent);" +
  "animation:nc-sheen 7s ease-in-out infinite;pointer-events:none}" +
"@media (prefers-reduced-motion:reduce){.nc-btn.primary::after{display:none}}" +

/* ---- chips and pills ---- */
".nc-chip{display:inline-flex;align-items:center;gap:6px;padding:4px 11px;border-radius:20px;" +
  "font-size:.74rem;font-weight:700;letter-spacing:.02em;border:1px solid var(--nc-bd);" +
  "background:var(--nc-s1);color:var(--nc-dim)}" +
".nc-chip.ok{color:var(--nc-ok);border-color:color-mix(in srgb,var(--nc-ok) 40%,transparent);" +
  "background:color-mix(in srgb,var(--nc-ok) 12%,transparent)}" +
".nc-chip.warn{color:var(--nc-warn);border-color:color-mix(in srgb,var(--nc-warn) 40%,transparent);" +
  "background:color-mix(in srgb,var(--nc-warn) 12%,transparent)}" +
".nc-chip.err{color:var(--nc-err);border-color:color-mix(in srgb,var(--nc-err) 40%,transparent);" +
  "background:color-mix(in srgb,var(--nc-err) 12%,transparent)}" +
".nc-chip.accent{color:var(--nc-cyan);border-color:color-mix(in srgb,var(--nc-cyan) 40%,transparent);" +
  "background:color-mix(in srgb,var(--nc-cyan) 12%,transparent)}" +

/* ---- stats ---- */
".nc-stats{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(168px,100%),1fr));gap:12px}" +
".nc-stat{padding:15px 17px;border-radius:var(--nc-r-md);border:1px solid var(--nc-bd);" +
  "background:var(--nc-s1);display:flex;flex-direction:column;gap:3px}" +
".nc-stat .k{font-size:.72rem;letter-spacing:.07em;text-transform:uppercase;font-weight:750;color:var(--nc-dim)}" +
".nc-stat .v{font-size:1.7rem;font-weight:760;letter-spacing:-.03em;font-variant-numeric:tabular-nums;line-height:1.14}" +
".nc-stat .d{font-size:.77rem;color:var(--nc-dim)}" +
".nc-stat .d.up{color:var(--nc-ok)}.nc-stat .d.down{color:var(--nc-err)}" +

/* ---- XP bar ----
   The shimmer sits inside the fill and is masked by it, so it reads as energy
   in the bar rather than a stripe crossing the whole track. */
".nc-xpbar{height:9px;border-radius:20px;background:var(--nc-xp-track);overflow:hidden;position:relative}" +
".nc-xpbar>span{display:block;height:100%;border-radius:20px;background:var(--nc-xp);" +
  "position:relative;overflow:hidden;transition:width .8s cubic-bezier(.22,.7,.3,1)}" +
".nc-xpbar>span::after{content:'';position:absolute;inset:0;" +
  "background:linear-gradient(100deg,transparent,rgba(255,255,255,.45),transparent);" +
  "transform:translateX(-100%);animation:nc-sheen 3.4s ease-in-out infinite}" +
"@media (prefers-reduced-motion:reduce){.nc-xpbar>span::after{display:none}" +
  ".nc-xpbar>span{transition:none}}" +
".nc-xpbar.thin{height:6px}" +

/* ---- level badge ---- */
".nc-lvl{display:inline-flex;align-items:center;justify-content:center;min-width:30px;height:30px;" +
  "padding:0 8px;border-radius:9px;font-size:.82rem;font-weight:800;letter-spacing:-.02em;" +
  "color:#1A1200;background:linear-gradient(135deg,var(--nc-lvl),var(--nc-lvl-2));" +
  "box-shadow:0 4px 14px -6px color-mix(in srgb,var(--nc-lvl) 70%,transparent)}" +
"html[data-theme=\"light\"] .nc-lvl{color:#fff}" +

/* ---- missions ---- */
".nc-progcard{display:block;margin:10px 12px 4px;padding:11px 12px;text-decoration:none;" +
  "color:inherit;border-radius:14px}" +
".nc-progcard:hover{border-color:var(--nc-bd2)}" +
".nc-mission{display:grid;grid-template-columns:44px minmax(0,1fr) auto;gap:13px;align-items:start;" +
  "padding:13px 15px;border-radius:var(--nc-r-md);border:1px solid var(--nc-bd);" +
  "background:var(--nc-s1);transition:border-color .16s ease,transform .16s ease}" +
"@media (hover:hover){.nc-mission:hover{transform:translateY(-2px);border-color:var(--nc-bd2)}}" +
".nc-mission .ic{width:44px;height:44px;align-self:center;border-radius:13px;display:grid;place-items:center;" +
  "font-size:1.2rem;background:var(--nc-s2);border:1px solid var(--nc-bd)}" +
/* These are spans so they can sit inside one grid cell; without display:block
   the title and the description run together on one line and the bar,
   being inline, collapses to nothing. */
".nc-mission .ttl{display:block;font-weight:660;font-size:.94rem;line-height:1.35}" +
".nc-mission .sub{display:block;font-size:.78rem;color:var(--nc-dim);margin-top:3px;line-height:1.45}" +
".nc-mission .bar{display:block;margin-top:8px}" +
".nc-mission .bar .nc-xpbar{display:block}" +
".nc-mission .rw{text-align:right;font-size:.76rem;color:var(--nc-dim);white-space:nowrap;padding-top:3px}" +
".nc-mission .rw b{display:block;font-size:.95rem;color:var(--nc-lvl);font-weight:760}" +
".nc-mission.done{border-color:color-mix(in srgb,var(--nc-ok) 45%,transparent);" +
  "background:color-mix(in srgb,var(--nc-ok) 8%,transparent)}" +
".nc-mission.done .ic{background:color-mix(in srgb,var(--nc-ok) 18%,transparent);" +
  "border-color:color-mix(in srgb,var(--nc-ok) 40%,transparent)}" +

/* ---- achievements ----
   Locked badges are desaturated rather than hidden: seeing what is next is the
   point of an achievement list. */
".nc-badges{display:grid;grid-template-columns:repeat(auto-fill,minmax(min(124px,100%),1fr));gap:12px}" +
".nc-badge{position:relative;padding:16px 12px 13px;border-radius:var(--nc-r-md);text-align:center;" +
  "border:1px solid var(--nc-bd);background:var(--nc-s1);transition:transform .18s ease,border-color .18s ease}" +
".nc-badge .medal{width:52px;height:52px;margin:0 auto 9px;border-radius:50%;display:grid;place-items:center;" +
  "font-size:1.45rem;background:radial-gradient(circle at 50% 30%,var(--nc-s3),var(--nc-s1));" +
  "border:1px solid var(--nc-bd2)}" +
".nc-badge .nm{font-size:.78rem;font-weight:700;line-height:1.3}" +
".nc-badge .req{font-size:.7rem;color:var(--nc-dim);margin-top:3px}" +
".nc-badge.locked{opacity:.45;filter:grayscale(1)}" +
".nc-badge.got{border-color:color-mix(in srgb,var(--nc-lvl) 45%,transparent)}" +
".nc-badge.got .medal{background:linear-gradient(150deg,var(--nc-lvl),var(--nc-lvl-2));color:#1A1200;" +
  "border-color:transparent;box-shadow:0 6px 20px -8px color-mix(in srgb,var(--nc-lvl) 70%,transparent)}" +
"@media (hover:hover){.nc-badge:hover{transform:translateY(-3px)}" +
  ".nc-badge.got:hover .medal{transform:rotate(-6deg) scale(1.06);transition:transform .2s ease}}" +

/* ---- states ----
   Empty, loading and error are designed, because a product is judged on the
   day it has no data as much as the day it does. */
".nc-empty{text-align:center;padding:36px 22px;border-radius:var(--nc-r-lg);" +
  "border:1px dashed var(--nc-bd2);background:var(--nc-s1);color:var(--nc-dim)}" +
".nc-empty .ic{width:52px;height:52px;margin:0 auto 12px;border-radius:16px;display:grid;place-items:center;" +
  "background:var(--nc-s2);border:1px solid var(--nc-bd);font-size:1.3rem}" +
".nc-empty h4{color:var(--nc-text);font-size:1rem;font-weight:680;margin-bottom:5px}" +
".nc-empty p{font-size:.85rem;line-height:1.6;max-width:42ch;margin:0 auto}" +
".nc-empty .nc-btn{margin-top:14px}" +
".nc-err-state{border-color:color-mix(in srgb,var(--nc-err) 40%,transparent);" +
  "background:color-mix(in srgb,var(--nc-err) 7%,transparent)}" +
".nc-err-state h4{color:var(--nc-err)}" +

/* ---- section heads ---- */
".nc-head{display:flex;align-items:baseline;gap:11px;flex-wrap:wrap;margin:0 0 13px}" +
".nc-head h3{font-size:1.06rem;font-weight:700;letter-spacing:-.02em}" +
".nc-head .sub{font-size:.82rem;color:var(--nc-dim)}" +
".nc-head .sp{flex:1}" +

/* ---- focus, one ring everywhere ---- */
".nc-btn:focus-visible,.nc-badge:focus-visible,.nc-mission:focus-visible{" +
  "outline:2px solid var(--nc-cyan);outline-offset:2px}" +

/* ---- mobile: designed, not shrunk ---- */
"@media (max-width:560px){" +
  ".nc-stats{grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}" +
  ".nc-stat{padding:12px 13px}.nc-stat .v{font-size:1.36rem}" +
  ".nc-mission{grid-template-columns:38px minmax(0,1fr);gap:11px;padding:12px 13px}" +
  ".nc-mission .ic{width:38px;height:38px;font-size:1.05rem}" +
  /* the reward moves under the title rather than squeezing a third column */
  ".nc-mission .rw{grid-column:1/-1;text-align:left;display:flex;gap:8px;align-items:baseline}" +
  ".nc-mission .rw b{display:inline}" +
  ".nc-badges{grid-template-columns:repeat(3,minmax(0,1fr));gap:9px}" +
  ".nc-badge{padding:12px 7px 10px}.nc-badge .medal{width:42px;height:42px;font-size:1.15rem}" +
  ".nc-btn.lg{padding:12px 20px;font-size:.94rem}" +
"}";
document.head.appendChild(ncDS);
...
function ncNav() {
  ...
  if (!document.getElementById('ncnavcss')) {
    ...
    st.textContent = [
      ...
      /* The strip is 940px of links inside a 390px bar. The sidebar clips it,
         so without this the last four destinations are unreachable on a phone
         and the row still pushes the document 52px wide. Scroll it instead. */
      '#ncnav{flex-direction:row;padding:0;gap:0;flex:1;min-width:0;overflow-x:auto;',
      'scrollbar-width:none;-webkit-overflow-scrolling:touch}',
      '#ncnav::-webkit-scrollbar{display:none}',
      /* The level card is a rail card and the phone rail is a 56px strip that
         already has the brand and eleven destinations in it. Squeezed in, it
         pushed the document 52px wider than the screen at every phone size.
         It comes out here — the coin count is in the corner badge, and the
         full bar is one tap away on Progress. */
      '#ncProg{display:none}',
      /* The profile row and the wordmark were taking the whole 390px strip,
         which left the nav 0px wide — every destination on the phone was
         unreachable, and the overflow pushed the page 52px sideways. The
         strip is for navigating; Home is the first item in it, and the
         profile lives on its own page. */
      '#ncprof,#ncbrand{display:none !important}',
...
(function () {
  const GENZ = {
    hero_line1:'ur idea', hero_line2:'to ur next vid fr',
    startchannel:'lock in', seerewards:'peep the rewards',
    startcreating:'lock in', seehow:'how it works',
