...
(function () {
  ...
  var UI = {
    ...
    speechLang: { en: 'Commands are matched in English, Persian, Spanish, Portuguese, French, German and Arabic; other languages fall back to English.', fa: 'فرمان‌ها به زبان انگلیسی و فارسی شناسایی می‌شوند.', es: 'Los comandos se reconocen en varios idiomas.', pt: 'Os comandos são reconhecidos em várias línguas.', fr: 'Les commandes sont reconnues en plusieurs langues.', de: 'Befehle werden in mehreren Sprachen erkannt.', ar: 'تُفهم الأوامر بعدة لغات.' },
   ...
   * ------------------------------------------------------------------ */
  var NAV = [
    { url: 'index.html', say: { en: ['home', 'main page', 'homepage'], fa: ['خانه', 'صفحه اصلی'], es: ['inicio', 'página principal'], pt: ['início', 'página inicial'], fr: ['accueil', 'page principale'], de: ['start', 'startseite'], ar: ['الرئيسية', 'الصفحة الرئيسية'] } },
    { url: 'app.html', say: { en: ['studio'], fa: ['استودیو'], es: ['estudio'], pt: ['estúdio'], fr: ['studio'], de: ['studio'], ar: ['استوديو'] } },
    { url: 'analytics.html', say: { en: ['analytics'], fa: ['تحلیل'], es: ['analíticas', 'analítica'], pt: ['análises', 'análitica'], fr: ['analytique', 'analyses'], de: ['analysen', 'analyse'], ar: ['التحليلات'] } },
    { url: 'trends.html', say: { en: ['trend spotter', 'trends', 'trend radar'], fa: ['ترند'], es: ['tendencias', 'tendencias'], pt: ['tendências'], fr: ['tendances'], de: ['trends', 'trend'], ar: ['الاتجاهات'] } },
    { url: 'editor.html', say: { en: ['editor'], fa: ['ویرایشگر', 'ادیتور'], es: ['editor'], pt: ['editor'], fr: ['éditeur'], de: ['editor'], ar: ['المحرر'] } },
    { url: 'game.html', say: { en: ['games', 'game hub'], fa: ['بازی'], es: ['juegos'], pt: ['jogos'], fr: ['jeux'], de: ['spiele'], ar: ['الألعاب'] } },
    { url: 'ai.html', say: { en: ['nova clip ai', 'ask the ai', 'chat'], fa: ['هوش مصنوعی'], es: ['la ia', 'asistente'], pt: ['a ia', 'assistente'], fr: ['ia', 'assistant'], de: ['ki', 'assistent'], ar: ['الذكاء الاصطناعي'] } },
    { url: 'progress.html', say: { en: ['progress'], fa: ['پیشرفت'], es: ['progreso'], pt: ['progresso'], fr: ['progression'], de: ['fortschritt'], ar: ['التقدم'] } },
    { url: 'pricing.html', say: { en: ['pricing', 'upgrade', 'pro plan'], fa: ['قیمت', 'ارتقا'], es: ['precios', 'premium'], pt: ['preços', 'premium'], fr: ['tarifs', 'premium'], de: ['preise', 'premium'], ar: ['الأسعار'] } },
    { url: 'tools.html', say: { en: ['tools'], fa: ['ابزار'], es: ['herramientas'], pt: ['ferramentas'], fr: ['outils'], de: ['werkzeuge', 'tools'], ar: ['الأدوات'] } },
    { url: 'community.html', say: { en: ['community'], fa: ['انجمن'], es: ['comunidad'], pt: ['comunidade'], fr: ['communauté'], de: ['community', 'gemeinschaft'], ar: ['المجتمع'] } },
    { url: 'coder.html', say: { en: ['coder', 'code lab'], fa: ['برنامه نویسی'], es: ['programar'], pt: ['programar'], fr: ['coder'], de: ['codieren'], ar: ['البرمجة'] } }
  ];
  var SAY_SIGNIN = { en: ['sign in', 'log in', 'sign me in', 'log me in'], fa: ['ورود'], es: ['iniciar sesión'], pt: ['iniciar sessão'], fr: ['connecte moi', 'se connecter'], de: ['anmelden'], ar: ['تسجيل الدخول'] };
  var SAY_SIGNOUT = { en: ['sign out', 'log out'], fa: ['خروج'], es: ['cerrar sesión'], pt: ['terminar sessão'], fr: ['deconnexion'], de: ['abmelden'], ar: ['تسجيل الخروج'] };
  var SAY_STOP = { en: ['stop listening', 'go to sleep'], fa: ['خاموش', 'بس کن'], es: ['deja de escuchar'], pt: ['para de ouvir'], fr: ['arrête'], de: ['stopp', 'schlafen'], ar: ['توقف'] };
  var SAY_HELP = { en: ['help', 'what can i say'], fa: ['کمک'], es: ['ayuda'], pt: ['ajuda'], fr: ['aide'], de: ['hilfe'], ar: ['مساعدة'] };
